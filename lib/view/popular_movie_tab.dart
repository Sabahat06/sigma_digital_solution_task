...
class PopularMovieTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(
        () => movieController.popularMovieLoading.value
          ? const Center(child: CircularProgressIndicator(),)
          : ListView.builder(
            itemCount: movieController.popularMovie.results!.length,
            shrinkWrap: true,
            itemBuilder: (context, index) {
              return renderingMovie(movieController.popularMovie.results![index]);
            }
          ),
      ),
    );
